...
public class DraggableDot extends View {
    ...
    public DraggableDot(Context context, AttributeSet attrs) {
        ...
        Log2.i(TAG, "DraggableDot @ " + this + " : radius=" + mRadius + " legend='" + mLegend
                + "' anr=" + mAnrType);
    ...
    public boolean onDragEvent(DragEvent event) {
        ...
        switch (event.getAction()) {
            case DragEvent.ACTION_DRAG_STARTED: {
                ...
                Log2.i(TAG, "Drag started, event=" + event);
            ...
            case DragEvent.ACTION_DRAG_LOCATION: {
                ...
                Log2.i(TAG, "... seeing drag locations ...");
                result = mAcceptsDrag;
            }
            break;

            case DragEvent.ACTION_DROP: {
                Log2.i(TAG, "Got a drop! dot=" + this + " event=" + event);
            ...
            default:
                Log2.i(TAG, "other drag event: " + event);
                result = mAcceptsDrag;
                break;
        }
    ...
    private void processDrop(DragEvent event) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            Log2.i(TAG, "Dropped item " + i + " : " + item);
            if (mReportView != null) {
