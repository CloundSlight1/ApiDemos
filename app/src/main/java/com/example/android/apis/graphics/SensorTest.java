...
public class SensorTest extends GraphicsActivity {
    ...
    private final SensorEventListener mListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (show) {
                ...
                Log2.e(TAG, "sensorChanged " + event.sensor.getName() +
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (false) Log2.d(TAG, "create " + mSensorManager);
    }
    ...
    protected void onResume() {
        ...
        if (false) Log2.d(TAG, "resume " + mSensorManager);
    }
    ...
    protected void onStop() {
        ...
        super.onStop();
        if (false) Log2.d(TAG, "stop " + mSensorManager);
    }
    ...
    private class SampleView extends View {
        ...
        protected void onAttachedToWindow() {
            mAnimate = true;
            if (false) Log2.d(TAG, "onAttachedToWindow. mAnimate=" + mAnimate);
