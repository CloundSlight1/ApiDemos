    ...
    public void onReceive(Context context, Intent intent) {
        if (Telephony.Sms.Intents.WAP_PUSH_RECEIVED_ACTION.equals(intent.getAction())
            ...
            try {
                ...
                Log2.e(TAG, "Invalid MMS WAP push", e);
            }
            if (pdu == null) {
                Log2.e(TAG, "Invalid WAP push data");
                return;
            }
            switch (pdu.getMessageType()) {
                case PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND: {
                    ...
                    Log2.v(TAG, "Received MMS notification: " + location);
                ...
                case PduHeaders.MESSAGE_TYPE_DELIVERY_IND: {
                    Log2.v(TAG, "Received delivery report");
                    break;
                }
                case PduHeaders.MESSAGE_TYPE_READ_ORIG_IND: {
                    Log2.v(TAG, "Received read report");
                    break;
                }
            }
        }
