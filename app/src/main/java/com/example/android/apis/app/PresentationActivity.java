...
public class PresentationActivity extends Activity
    ...
    protected void onPause() {
        ...
        Log2.d(TAG, "Activity is being paused.  Dismissing all active presentation.");
    ...
    private void showPresentation(Display display, DemoPresentationContents contents) {
        ...
        Log2.d(TAG, "Showing presentation photo #" + contents.photo
    ...
    private void hidePresentation(Display display) {
        ...
        Log2.d(TAG, "Dismissing presentation on display #" + displayId + ".");
    ...
    private final DisplayManager.DisplayListener mDisplayListener =
            new DisplayManager.DisplayListener() {
                ...
                public void onDisplayAdded(int displayId) {
                    Log2.d(TAG, "Display #" + displayId + " added.");
                    mDisplayListAdapter.updateContents();
                }

                @Override
                public void onDisplayChanged(int displayId) {
                    Log2.d(TAG, "Display #" + displayId + " changed.");
                    mDisplayListAdapter.updateContents();
                }

                @Override
                public void onDisplayRemoved(int displayId) {
                    Log2.d(TAG, "Display #" + displayId + " removed.");
                    mDisplayListAdapter.updateContents();
                }
            };
    ...
    private final DialogInterface.OnDismissListener mOnDismissListener =
            new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialog) {
                    ...
                    Log2.d(TAG, "Presentation on display #" + displayId + " was dismissed.");
                    mActivePresentations.delete(displayId);
    ...
    private final class DisplayListAdapter extends ArrayAdapter<Display> {
        ...
        public void updateContents() {
            ...
            Log2.d(TAG, "There are currently " + displays.length + " displays connected.");
