...
public class ContactsSelectInstrumentation extends Instrumentation {
    ...
    public void onStart() {
        ...
        Log2.i("ContactsSelectInstrumentation", "Started: " + activity);
        ...
        if (checkMonitorHit(am, 1)) {
            Log2.i("ContactsSelectInstrumentation", "Activity started!");
        } else {
            Log2.i("ContactsSelectInstrumentation", "*** ACTIVITY NOT STARTED!");
        }

        // And we are done!
        Log2.i("ContactsSelectInstrumentation", "Done!");
