...
public class IsolatedService extends Service {
    ...
    public void onCreate() {
        Log2.i("IsolatedService", "Creating IsolatedService: " + this);
    }

    @Override
    public void onDestroy() {
        Log2.i("IsolatedService", "Destroying IsolatedService: " + this);
    ...
    public void onTaskRemoved(Intent rootIntent) {
        Log2.i("IsolatedService", "Task removed in " + this + ": " + rootIntent);
        stopSelf();
    }
