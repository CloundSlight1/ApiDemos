...
public class TaskBackService extends AccessibilityService implements OnInitListener {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        if (!mTextToSpeechInitialized) {
            Log2.e(LOG_TAG, "Text-To-Speech engine not ready.  Bailing out.");
            return;
        }
        ...
        Log2.d(LOG_TAG, String.format("onAccessibilityEvent: %s, type: %X",
                event.getClassName(), event.getEventType()));
        ...
        Log2.d(LOG_TAG, utterance.toString());
    }
